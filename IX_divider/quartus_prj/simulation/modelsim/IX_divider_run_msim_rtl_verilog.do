...
vlog -vlog01compat -work work +incdir+D:/GitHub/fpga_learing/IX_divider/rtl {D:/GitHub/fpga_learing/IX_divider/rtl/IX_divider.v}

vlog -vlog01compat -work work +incdir+D:/GitHub/fpga_learing/IX_divider/quartus_prj/../sim {D:/GitHub/fpga_learing/IX_divider/quartus_prj/../sim/tb_divider.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_divider

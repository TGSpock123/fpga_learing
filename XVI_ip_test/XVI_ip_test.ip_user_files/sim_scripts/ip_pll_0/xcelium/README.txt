...
#
# Generated by export_simulation on Fri Aug 15 08:29:14 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ip_pll_0.sh' script.

./ip_pll_0.sh -reset_run
...
./ip_pll_0.sh -noclean_files

For more information on the script, please type './ip_pll_0.sh -help'.

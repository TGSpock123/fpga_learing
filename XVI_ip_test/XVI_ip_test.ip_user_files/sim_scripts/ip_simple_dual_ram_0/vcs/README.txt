...
#
# Generated by export_simulation on Tue Aug 19 23:25:22 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ip_simple_dual_ram_0.sh' script.

./ip_simple_dual_ram_0.sh -reset_run
...
./ip_simple_dual_ram_0.sh -noclean_files

For more information on the script, please type './ip_simple_dual_ram_0.sh -help'.

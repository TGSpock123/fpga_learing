...
HD_PWD='D:/GitHub/fpga_learing/XVI_ip_test/XVI_ip_test.runs/ip_simple_dual_ram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_simple_dual_ram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_simple_dual_ram_0.tcl

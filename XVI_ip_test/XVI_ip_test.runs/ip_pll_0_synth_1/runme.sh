...
HD_PWD='D:/GitHub/fpga_learing/XVI_ip_test/XVI_ip_test.runs/ip_pll_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_pll_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_pll_0.tcl

...
HD_PWD='D:/GitHub/fpga_learing/XVI_ip_test/XVI_ip_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_single_ram_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_single_ram_test.tcl

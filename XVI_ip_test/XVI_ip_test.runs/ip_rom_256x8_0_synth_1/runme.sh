...
HD_PWD='D:/GitHub/fpga_learing/XVI_ip_test/XVI_ip_test.runs/ip_rom_256x8_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_rom_256x8_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_rom_256x8_0.tcl

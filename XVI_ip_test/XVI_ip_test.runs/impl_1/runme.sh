...
HD_PWD='D:/GitHub/fpga_learing/XVI_ip_test/XVI_ip_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_single_ram_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ip_single_ram_test.tcl -notrace

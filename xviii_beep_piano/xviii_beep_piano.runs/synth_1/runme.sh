...
HD_PWD='D:/GitHub/fpga_learing/xviii_beep_piano/xviii_beep_piano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xviii_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xviii_top.tcl

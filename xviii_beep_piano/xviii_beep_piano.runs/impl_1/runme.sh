...
HD_PWD='D:/GitHub/fpga_learing/xviii_beep_piano/xviii_beep_piano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xviii_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xviii_top.tcl -notrace

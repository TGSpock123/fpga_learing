...
HD_PWD='D:/GitHub/fpga_learing/xix_quick_demo/xix_quick_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vhdl_quick_demo_silly.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vhdl_quick_demo_silly.tcl

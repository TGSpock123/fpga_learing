...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../xx_fft_lab.gen/sources_1/ip/dds_ila/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dds_ila xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dds_ila -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tgspock/Github/fpga_learing/xx_fft_lab/xx_fft_lab.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dds_ila_sc.so .tmp_log xcelium_lib waves.shm c.obj)

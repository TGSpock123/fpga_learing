...
#
# Script generated by Vivado on Wed Apr 01 19:27:39 CST 2026
...
#
# Usage        : dds_ila.sh
#                dds_ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dds_ila.sh [-reset_run]
#                dds_ila.sh [-reset_log]
#                dds_ila.sh [-help]
#
...
#                script (type 'dds_ila.sh -help' for more information).
#
...
# script info
echo -e "dds_ila.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dds_ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../xx_fft_lab.gen/sources_1/ip/dds_ila/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dds_ila xil_defaultlib.glbl -o dds_ila_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dds_ila_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tgspock/Github/fpga_learing/xx_fft_lab/xx_fft_lab.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dds_ila_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dds_ila_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dds_ila.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dds_ila.sh [-help]\n\
Usage: dds_ila.sh [-step]\n\
Usage: dds_ila.sh [-lib_map_path]\n\
Usage: dds_ila.sh [-reset_run]\n\
Usage: dds_ila.sh [-reset_log]\n\
Usage: dds_ila.sh [-keep_index]\n\
Usage: dds_ila.sh [-noclean_files]\n\n\

...
HD_PWD='/home/tgspock/Github/fpga_learing/xx_fft_lab/xx_fft_lab.runs/dds_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_ila.tcl

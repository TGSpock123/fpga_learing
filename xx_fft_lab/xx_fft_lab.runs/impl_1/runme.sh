...
HD_PWD='/home/tgspock/Github/fpga_learing/xx_fft_lab/xx_fft_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_lab_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_lab_top.tcl -notrace

...
HD_PWD='/home/tgspock/Github/fpga_learing/xx_fft_lab/xx_fft_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_lab_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_lab_top.tcl

...
HD_PWD='D:/GitHub/fpga_learing/XV_button_debounce/XV_button_debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_debounce.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_debounce.tcl

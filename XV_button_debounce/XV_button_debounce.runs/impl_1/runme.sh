...
HD_PWD='D:/GitHub/fpga_learing/XV_button_debounce/XV_button_debounce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log button_debounce.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source button_debounce.tcl -notrace

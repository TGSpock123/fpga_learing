...
HD_PWD='D:/GitHub/fpga_learing/XIII_simple_fsm/XIII_simple_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_fsm.tcl

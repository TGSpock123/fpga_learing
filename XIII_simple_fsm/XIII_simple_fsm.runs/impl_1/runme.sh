...
HD_PWD='D:/GitHub/fpga_learing/XIII_simple_fsm/XIII_simple_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_fsm.tcl -notrace

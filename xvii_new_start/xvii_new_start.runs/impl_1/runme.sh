...
HD_PWD='D:/GitHub/fpga_learing/xvii_new_start/xvii_new_start.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xvii_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xvii_top.tcl -notrace

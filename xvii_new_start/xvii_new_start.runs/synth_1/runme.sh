...
HD_PWD='D:/GitHub/fpga_learing/xvii_new_start/xvii_new_start.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xvii_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xvii_top.tcl

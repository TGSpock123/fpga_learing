...
REM
REM Generated by Vivado on Thu Oct 30 18:04:31 +0800 2025
...
echo "xvlog --incr --relax -prj xvii_top_vlog.prj"
call xvlog  --incr --relax -prj xvii_top_vlog.prj -log xvlog.log
